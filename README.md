...
![](https://img.shields.io/badge/Moves%20played-68-blue)
...
Game over, the blue team has won! [Click here to start a new game!](https://github.com/JohnyP36/Connect4/issues/new?title=connect4%7Cnew&body=Just+push+%27Submit+new+issue%27+without+editing+the+title.+The+README+will+be+updated+after+approximately+30+seconds.)
...
| Team | Move | Made by |
| ---- | ---- | ------- |
| Blue | 2 | [@BPower0036](https://github.com/BPower0036) |
| Red | 2 | Connect4Bot on behalf of [@BPower0036](https://github.com/BPower0036) |
| Blue | 1 | Connect4Bot on behalf of [@BPower0036](https://github.com/BPower0036) |
| Red | 1 | [@BPower0036](https://github.com/BPower0036) |
